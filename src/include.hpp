...
// "is_board_valid" permet de verifier que le format du plateau est bien valide
bool is_board_valid(std::string& board);

// "is_hand_valid" permet de verifier le format de la main que les lettres sont majuscules
...
// "extract_board_hand" permet d'extraire le plateau et la mainà partir du text
