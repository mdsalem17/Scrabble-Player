...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/test_gaddag
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/test_gaddag
  DEFINES   += -DDEBUG
  INCLUDES  += 
...
ifeq ($(config),release)
  OBJDIR     = obj/release/test_gaddag
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/test_gaddag
  DEFINES   += 
  INCLUDES  += 
...
$(OBJDIR)/bonus.o: src/bonus.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/lexicon.o: src/lexicon.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/include.o: src/include.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/bag.o: src/bag.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
